...
|---|---|
| `artx init [dir]` | Create a vault: directory skeleton, `git init`, `.gitattributes`, `.gitignore`, `AGENTS.md`. Requires a new or empty directory outside any git repo (`--force` overrides) |
